...
// نفس منطق الصورة الأصلي حرفياً — CMS أولاً، ثم Unsplash الافتراضي
function resolveBgImage(url?: string) {
...
export default function HeroSection({ hero }: HeroSectionProps) {
  const bgImage = resolveBgImage(hero?.backgroundImageUrl);
    ...
    <div className="relative w-full">
      ...
      <section className="relative overflow-hidden w-full text-white min-h-[360px] sm:min-h-[500px] lg:min-h-[560px] pt-24 sm:pt-36 lg:pt-40 pb-36 sm:pb-44 lg:pb-48 flex flex-col items-center justify-center">
        ...
        {/* LCP image — عنصر <img> حقيقي قابل للاكتشاف + priority يُحقن preload تلقائياً.
            بدون quality مخصص (الافتراضي 75 مثبت السلامة على optimizer) */}
      ...
      {/* ── 2. Floating Search Console (Client Island — نفس المنطق الأصلي) ── */}
      <HeroSearch />
