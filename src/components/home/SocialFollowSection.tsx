  ...
  return (
    <section className="py-10 sm:py-14 bg-white border-t border-neutral-100 overflow-hidden w-full">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Section Header */}
        <div className="text-center mb-6 sm:mb-8 max-w-xl mx-auto" style={{ direction: 'rtl' }}>
          <h3 className="text-lg sm:text-xl font-black text-[var(--brand-primary)] tracking-tight mb-1">
        ...
        {/* ── 6 Centered High-End Interactive Social Badges ── */}
        <div className="flex flex-wrap items-center justify-center gap-3.5 sm:gap-5 lg:gap-6 max-w-3xl mx-auto">
          {socialLinks.map((social) => (
            <a
              ...
              className={`group relative flex flex-col items-center justify-center w-14 h-14 sm:w-16 sm:h-16 lg:w-18 lg:h-18 rounded-2xl sm:rounded-3xl bg-gradient-to-br ${social.bgGradient} border ${social.borderAccent} shadow-md ${social.hoverShadow} hover:-translate-y-2 hover:scale-110 active:scale-95 transition-all duration-300 shrink-0`}
