  ...
  return (
    <div className="bg-white rounded-3xl shadow-xl border border-neutral-100 overflow-hidden max-w-md mx-auto w-full hover:shadow-2xl transition-shadow duration-500">
      ...
      <div className="p-8 text-center">
        ...
        <p className="text-neutral-500 text-sm">حالة الطلب: {paymentMethod === 'transfer' ? 'بانتظار تأكيد الدفع ⏱️' : 'بانتظار تواصل خدمة العملاء للتأكيد ⏱️'}</p>
        ...
        <div className="mb-6 p-4 rounded-xl border border-amber-200 bg-amber-50 text-start">
          <p className="text-sm font-bold text-amber-800 mb-1">الخطوة التالية</p>
          <p className="text-xs text-amber-700 leading-relaxed">
            طلبك غير مؤكد نهائيًا حتى إتمام خطوة الدفع والتحقق منه من فريق مساري.
            احتفظ برقم الحجز المرجعي واستخدمه عند التواصل.
          </p>
        </div>
        ...
        {paymentMethod === 'transfer' && (
          <div className="mb-6 p-5 bg-emerald-50 border border-emerald-100 rounded-2xl text-center">
            <p className="text-sm font-black text-emerald-800 mb-2">الخطوة المطلوبة الآن</p>
