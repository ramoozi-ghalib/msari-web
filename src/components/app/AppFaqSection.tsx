...
const FAQS = [
  {
    ...
    a: 'نعم، تطبيق مساري مجاني 100% للتحميل على أجهزة أندرويد و iOS، ولا توجد أي رسوم اشتراك أو رسوم حجز خفية. الأسعار المعروضة في التطبيق هي الأسعار الفعلية للغرف.',
  },
  {
  ...
  {
    q: 'كيف استلم قسيمة الحجز وتأكيد الغرفة؟',
    a: 'فور إتمام الحجز، يصدر التطبيق قسيمة حجز رقمية معتمدة برقم مرجعي رسمي وكود QR. تظل القسيمة محفوظة على هاتفك ويمكنك فتحها بدون إنترنت (Offline) أو تنزيلها بصيغة PDF لتقديمها لموظف الاستقبال مباشرة.',
  },
  {
    q: 'هل الفنادق المعروضة في التطبيق مضمونة وتوفر كهرباء وخدمات مستمرة؟',
    a: 'نعم، يتم فحص وتدقيق الفنادق الشريكة في مساري، وتوضح بطاقة كل فندق بدقة تفاصيل توفر الكهرباء 24/7، خدمات التكييف، الإنترنت المجاني، والموقع الجغرافي لضمان إقامة مريحة ومطابقة لتوقعاتك.',
  },
  {
