...
export default function AppDownloadCtaSection({ isEn = false, data }: Props) {
  ...
  return (
    <section className="py-16 lg:py-24 bg-white container-msari px-4">
      <div
        className="relative rounded-3xl overflow-hidden p-8 sm:p-14 lg:p-16 shadow-2xl border border-white/20"
        style={{
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center relative z-10">
          ...
          <div className="lg:col-span-8 space-y-6 text-center lg:text-start">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 text-white text-xs font-black border border-white/20">
            ...
            <p className="text-[#F4F2F8] text-base sm:text-lg font-bold max-w-2xl leading-relaxed">
              {ctaSubtitle}
            </p>
            ...
            <div className="pt-4 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              ...
              <a
                ...
                className="flex items-center gap-3.5 px-6 py-3.5 bg-white hover:bg-[#FF3B30] text-[#23096E] hover:text-white rounded-2xl shadow-xl font-black transition-all transform hover:-translate-y-1 group"
              >
            ...
            {/* Micro trust row */}
            <div className="pt-2 flex flex-wrap items-center justify-center lg:justify-start gap-4 text-[11px] text-white/80 font-bold">
