    ...
    <section className="py-12 sm:py-16 lg:py-24 bg-white container-msari px-4 sm:px-6">
      ...
      >
        ...
        <div className="max-w-3xl mx-auto text-center space-y-4 sm:space-y-6 relative z-10">
          ...
          <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-white leading-tight drop-shadow-md">
            {ctaTitle}
          </h2>

          <p className="text-[#F4F2F8] text-xs sm:text-sm lg:text-base font-medium max-w-2xl mx-auto leading-relaxed">
            {ctaSubtitle}
          </p>
          ...
          {/* Micro trust row */}
          <div className="pt-2 flex flex-wrap items-center justify-center gap-3 sm:gap-4 text-[11px] text-white/80 font-bold">
