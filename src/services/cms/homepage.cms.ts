...
const FALLBACK_HOMEPAGE: HomepageContentData = {
  ...
  appDownload: {
    ...
    samsungScreenImageUrl: '',
    iphoneScreenImageUrl: '',
    playStoreUrl: 'https://play.google.com/store/apps/details?id=net.msari.app',
    appStoreUrl: 'https://apps.apple.com',
  },
  socialFollow: {
    isVisible: true,
    titleAr: 'صفحاتنا على وسائل التواصل الاجتماعي',
    subtitleAr: 'تابع مساري وابقَ على اطلاع بأحدث العروض والوجهات السياحية',
    whatsappUrl: '',
    facebookUrl: 'https://facebook.com/msariapp',
    instagramUrl: 'https://instagram.com/msariapp',
    tiktokUrl: 'https://tiktok.com/@msariapp',
    xUrl: 'https://x.com/msariapp',
    telegramUrl: 'https://t.me/msariapp',
  },
  updatedAt: null,
};
...
async function fetchHomepageInternal(): Promise<HomepageContentData> {
  ...
  return {
    ...
    appDownload: {
      ...
      samsungScreenImageUrl: data.appDownload?.samsungScreenImageUrl || (data.appDownload as any)?.androidScreenImageUrl || '',
      iphoneScreenImageUrl: data.appDownload?.iphoneScreenImageUrl || (data.appDownload as any)?.iosScreenImageUrl || '',
    ...
    socialFollow: {
      isVisible: data.socialFollow?.isVisible !== undefined ? Boolean(data.socialFollow.isVisible) : true,
      titleAr: data.socialFollow?.titleAr || FALLBACK_HOMEPAGE.socialFollow?.titleAr,
      subtitleAr: data.socialFollow?.subtitleAr || FALLBACK_HOMEPAGE.socialFollow?.subtitleAr,
      whatsappUrl: data.socialFollow?.whatsappUrl || '',
      facebookUrl: data.socialFollow?.facebookUrl || FALLBACK_HOMEPAGE.socialFollow?.facebookUrl || '',
      instagramUrl: data.socialFollow?.instagramUrl || FALLBACK_HOMEPAGE.socialFollow?.instagramUrl || '',
      tiktokUrl: data.socialFollow?.tiktokUrl || FALLBACK_HOMEPAGE.socialFollow?.tiktokUrl || '',
      xUrl: data.socialFollow?.xUrl || FALLBACK_HOMEPAGE.socialFollow?.xUrl || '',
      telegramUrl: data.socialFollow?.telegramUrl || FALLBACK_HOMEPAGE.socialFollow?.telegramUrl || '',
    },
