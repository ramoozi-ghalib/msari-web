...
export const FALLBACK_DEVELOPERS: DevelopersPageData = {
  ...
  features: [
    { icon: 'Zap', title: 'استجابة فائقة السرعة', desc: 'واجهة RESTful مبنية بأحدث معايير الأداء لمعالجة الطلبات اللحظية بكفاءة عالية.' },
    { icon: 'ShieldCheck', title: 'توثيق وأمان عالي', desc: 'مفاتيح API مشفرة مع صلاحيات دقيقة وتشفير كامل للبيانات عبر بروتوكول TLS 1.3.' },
    { icon: 'Coins', title: 'تسعير متعدد العملات', desc: 'تحديث لحظي لأسعار الغرف والتوفر بالريال اليمني والدولار والريال السعودي بدون عمولات خفية.' },
    { icon: 'Cpu', title: 'تأكيد حجز فوري معتمد', desc: 'خصم مباشر من التوفر وإصدار رقم مرجعي رسمي وقسيمة إلكترونية معتمدة من الفندق.' },
  ],
  plans: [
    {
      id: 'b2b_integration',
