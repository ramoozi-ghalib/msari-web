...
export const FALLBACK_APP_PAGE: AppPageData = {
  ...
  howItWorks: [
    { step: '01', title: '1. حمّل التطبيق', desc: 'اختر متجرك المفضل Google Play أو App Store لتثبيت التطبيق مجاناً.' },
    { step: '02', title: '2. اختر وجهتك وفندقك', desc: 'تصفح مئات الفنادق والخيارات وقارن الأسعار والصور المناسبة لك.' },
    { step: '03', title: '3. احجز واستلم القسيمة', desc: 'أكد حجزك فوريًا واستلم قسيمة إقامتك المعتمدة مباشرة على هاتفك.' },
  ],
  cta: {
