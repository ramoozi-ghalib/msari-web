...
export const FALLBACK_APP_PAGE: AppPageData = {
  ...
  howItWorks: [
    { step: '01', title: '١. حمّل التطبيق', desc: 'اختر متجرك المفضل Google Play أو App Store لتثبيت التطبيق مجاناً.' },
    { step: '02', title: '٢. اختر وجهتك وغرفتك', desc: 'تصفح فنادق اليمن وقارن الأسعار الحية والصور المناسبة لك.' },
    { step: '03', title: '٣. أكد حجزك وسدد بسهولة', desc: 'ادفع عبر المحافظ أو تحويل بنكي أو كاش، واستلم تأكيد حجزك الرسمي فوراً.' },
  ],
  cta: {
