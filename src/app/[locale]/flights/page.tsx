        ...
        <div className="bg-white rounded-3xl p-6 lg:p-8 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] border border-neutral-100/50">
          ...
          <form onSubmit={handleSearch} className="space-y-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-3">
              ...
              {/* Origin & Destination */}
              <div className="lg:col-span-7 relative flex flex-col md:flex-row gap-2">
            ...
            {/* Action Button Row (Below Fields) */}
            <div className="pt-2 flex justify-center">
              <button type="submit" 
                className="w-full sm:w-auto px-10 py-4 rounded-2xl flex items-center justify-center gap-2.5 text-white font-black transition-transform hover:-translate-y-0.5 shadow-lg shadow-[#23096e]/20 text-base"
