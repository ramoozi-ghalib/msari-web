        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            <Link href="/" className="flex items-center gap-3 group">
              ...
              <div>
                <span className="text-xl font-black tracking-wide leading-tight block text-white">مساري <span className="text-blue-300">للمطورين</span></span>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black leading-tight text-white" style={{ color: '#ffffff' }}>
              <span className="text-white" style={{ color: '#ffffff' }}>اربط نظامك مع مخزون</span> <br/> <span className="text-transparent bg-clip-text bg-gradient-to-l from-blue-300 to-purple-300">أكبر شبكة سفر في اليمن</span>
            </h1>
            ...
            <div className="flex items-center justify-center pt-4">
              <a href="#pricing" className="px-10 py-4 bg-white text-[#23096e] rounded-xl font-black text-lg hover:bg-neutral-100 transition-all hover:scale-105 active:scale-95 shadow-xl flex items-center justify-center gap-2">
                اكتشف خطط الشراكة
              </a>
            </div>
          </div>
      ...
      <div id="pricing" className="container mx-auto px-4 sm:px-6 lg:px-8 mb-24 scroll-mt-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div 
            ...
            className="group bg-white rounded-3xl p-8 shadow-md border-2 border-neutral-200 hover:border-[#23096e] transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl cursor-pointer flex flex-col justify-between relative overflow-hidden"
          >
            <div>
              <div className="inline-block px-3 py-1 bg-blue-50 text-[#23096e] text-xs font-black rounded-full mb-4">
                الفئة العادية
              </div>
              <h3 className="text-2xl font-black text-neutral-900 mb-2 group-hover:text-[#23096e] transition-colors">نظام العمولة</h3>
            ...
            <button className="w-full py-4 rounded-xl font-black bg-neutral-100 text-neutral-900 group-hover:bg-[#23096e] group-hover:text-white transition-all duration-300 flex items-center justify-center gap-2 shadow-sm group-hover:shadow-md">
          ...
          <div 
            ...
            className="group bg-[#23096e] text-white rounded-3xl p-8 shadow-2xl relative border-2 border-[#4a1fb8] hover:border-blue-400 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl cursor-pointer flex flex-col justify-between overflow-hidden"
          >
            ...
            <div>
              <div className="inline-block px-3 py-1 bg-white/10 text-blue-200 text-xs font-black rounded-full mb-4 mt-2">
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-start gap-3 text-sm font-bold text-white">
                  <CheckCircle2 size={18} className="text-blue-300 shrink-0 mt-0.5" /> <strong>بدون عمولة حجز (0% عمولة)</strong>
                </li>
                <li className="flex items-start gap-3 text-sm font-bold text-white">
                  <CheckCircle2 size={18} className="text-blue-300 shrink-0 mt-0.5" /> وصول غير محدود لقواعد البيانات والغرف والأسعار والصور
                </li>
                <li className="flex items-start gap-3 text-sm font-bold text-white">
                  <CheckCircle2 size={18} className="text-blue-300 shrink-0 mt-0.5" /> نظام حجز آلي فوري ومباشر مع وسائل الدفع
                </li>
                <li className="flex items-start gap-3 text-sm font-bold text-white">
                  <CheckCircle2 size={18} className="text-blue-300 shrink-0 mt-0.5" /> كامل بيانات المدن والوجهات السياحية
                </li>
                <li className="flex items-start gap-3 text-sm font-bold text-white">
                  <CheckCircle2 size={18} className="text-blue-300 shrink-0 mt-0.5" /> أولوية القصوى في الدعم الفني وتوليد مفاتيح API
                </li>
                <li className="flex items-start gap-3 text-sm font-bold text-white">
                  <CheckCircle2 size={18} className="text-blue-300 shrink-0 mt-0.5" /> مدير حساب مخصص للشراكة
                </li>
              </ul>
            </div>
            
            <button className="w-full py-4 rounded-xl font-black bg-white text-[#23096e] group-hover:bg-blue-400 group-hover:text-white transition-all duration-300 flex items-center justify-center gap-2 shadow-lg">
              <MessageSquare size={18} />
