...
export default function AddHotelPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--surface-page)]">
      ...
      {/* Benefits — بطاقتان فقط بدون لوحة تحكم */}
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input type="number" value={form.suites} onChange={e => set('suites', e.target.value)} placeholder="مثال: 5" className="input-msari" min="0" />
                  </div>
                </div>
                <div>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input type="text" value={form.position} onChange={e => set('position', e.target.value)} placeholder="مالك / مدير / مسؤول حجوزات" required className="input-msari" />
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div>
