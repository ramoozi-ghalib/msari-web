...
export interface Amenity {
  ...
  nameEn: string;
  icon: string;
  // يطابق AmenityCategory enum في schema.prisma
  category: 'general' | 'sport' | 'dining' | 'wellness' | 'business' | 'room';
}
...
export interface User {
  ...
  phone?: string;
  avatar?: string;
  role: 'user' | 'admin' | 'super_admin' | 'ADMIN' | 'BOOKING_STAFF' | 'CUSTOMER';
  createdAt?: string;
