-- =============================================================================
-- Msari Web — Seed Data (فنادق يمنية حقيقية)
...
INSERT INTO hotels (
  ...
  (
    ...
    'يقع فندق موفنبيك في قلب العاصمة صنعاء ويوفر إقامة فاخرة مع إطلالات رائعة على المدينة القديمة. يتميز الفندق بمرافق عالمية المستوى وخدمات متميزة.',
  ...
  (
    ...
    'فندق هيلتون صنعاء وجهة مثالية للمسافرين من رجال الأعمال والسياح، يقدم مزيجاً من الأجواء العربية الأصيلة مع الراحة العصرية.',
  ...
  (
    ...
    'فندق قمر عدن المطل على خليج عدن الساحر، يوفر إقامة لا تُنسى مع إطلالات بانورامية على البحر العربي وأجواء استوائية خلابة.',
  ...
  (
    ...
    'Eastern Hotel in the heart of the mountainous Ta''iz city, provides a calm atmosphere.',
