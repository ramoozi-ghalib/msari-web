...
async function run() {
  console.log('🚀 Synchronizing all 17 CMS sections to Firestore (msariapp-v2)...');
  ...
  console.log('✅ [1/13] website_settings/general');
  ...
  console.log('✅ [2/13] website_homepage/main');
  ...
  console.log('✅ [3/13] website_pages/about');
  ...
  console.log('✅ [4/13] website_pages/privacy');
  ...
  console.log('✅ [5/13] website_pages/terms');
  ...
  console.log('✅ [6/13] website_pages/developers');
  ...
  console.log('✅ [7/13] website_pages/app');
  ...
  console.log('✅ [8/13] website_pages/cars');
  ...
  console.log('✅ [9/13] website_pages/cars_airport');
  ...
  console.log('✅ [10/13] website_pages/cars_transport');
  ...
  console.log('✅ [11/13] website_pages/flights');
  ...
  console.log('✅ [12/13] website_pages/international_hotels');
  ...
  console.log('✅ [13/13] website_pages/add_hotel');

  console.log('🎉🎉 All 17 CMS sections synchronized successfully!');
  process.exit(0);
}

run().catch(err => {
  console.error('❌ Error synchronizing CMS:', err);
  process.exit(1);
});
